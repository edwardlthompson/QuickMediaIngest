...
namespace QuickMediaIngest.ViewModels
{
    public partial class MainViewModel
    {
        ...
        public void ApplyConfigToViewModel(QuickMediaIngest.AppConfig config)
        {
            ...
            try
            {
                ...
                StripGpsAndPiiOnEmbed = config.StripGpsAndPiiOnEmbed;
                EjectAfterImport = config.EjectAfterImport;
                ...
                OnPropertyChanged(nameof(StripGpsAndPiiOnEmbed));
                OnPropertyChanged(nameof(EjectAfterImport));
                ...
                _namingTemplateBySource.Clear();
                foreach (var kvp in config.NamingTemplateBySource ?? new Dictionary<string, string>())
                {
                    if (!string.IsNullOrWhiteSpace(kvp.Key) && !string.IsNullOrWhiteSpace(kvp.Value))
                    {
                        _namingTemplateBySource[kvp.Key] = kvp.Value;
                    }
                }
