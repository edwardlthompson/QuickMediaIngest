...
2. Read @.cursor/commands/prerelease.md — execute fully (deps already updated: audit-only + Release Please dry-run + autofix + optional Codex + `pre-release-gate.sh --local`)
