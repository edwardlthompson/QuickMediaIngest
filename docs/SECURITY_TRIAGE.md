...
4. Verify `.github/dependabot.yml` exists for `nuget` and `github-actions`
...
| 4 | AUTO | CI (Trivy, CodeQL, dotnet test) validates merge |
...
| `.github/workflows/codeql.yml` | CodeQL static analysis (C#) |
